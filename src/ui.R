...
fluidPage(align='center',
  ...
  sidebarLayout(
    sidebarPanel(align='center',
      ...
      h3("Parâmetros"),
      h4(HTML("<strong>Matriz de Contactos</strong>")),
      ...
      h4(HTML("<strong>Vacinação</strong>")),
      fluidRow(align='center',
      ...
      h4(HTML("<strong>Dos 0 aos 9 anos</strong>")),
      fluidRow(align='center',
        column(4, numericInput("T0_1", "Pessoas"    , min=0, value=Def_T0[1],
                               step=100)),
        ...
        column(3, numericInput("NVax_1", "Antivaxx/Não Vacinável",
                               min=0, value=100*Def_NVax[1], max=100)),
        column(3, numericInput("LE_1", "Esperança Média de Vida",
                               min=0, value=Def_LifeExp[1], max=100)),
      ),

      h4(HTML("<strong>Dos 10 aos 19 anos</strong>")),
      fluidRow(align='center',
        column(4, numericInput("T0_2", "Pessoas"    , min=0, value=Def_T0[2],
                               step=100)),
        ...
        column(3, numericInput("NVax_2", "Antivaxx/Não Vacinável",
                               min=0, value=100*Def_NVax[2], max=100)),
        column(3, numericInput("LE_2", "Esperança Média de Vida",
                               min=0, value=Def_LifeExp[2], max=100)),
      ),

      h4(HTML("<strong>Dos 20 aos 29 anos</strong>")),
      fluidRow(align='center',
        column(4, numericInput("T0_3", "Pessoas"    , min=0, value=Def_T0[3],
                               step=100)),
        ...
        column(3, numericInput("NVax_3", "Antivaxx/Não Vacinável",
                               min=0, value=100*Def_NVax[3], max=100)),
        column(3, numericInput("LE_3", "Esperança Média de Vida",
                               min=0, value=Def_LifeExp[3], max=100)),
      ),

      h4(HTML("<strong>Dos 30 aos 39 anos</strong>")),
      fluidRow(align='center',
        column(4, numericInput("T0_4", "Pessoas"    , min=0, value=Def_T0[4],
                               step=100)),
        ...
        column(3, numericInput("NVax_4", "Antivaxx/Não Vacinável",
                               min=0, value=100*Def_NVax[4], max=100)),
        column(3, numericInput("LE_4", "Esperança Média de Vida",
                               min=0, value=Def_LifeExp[4], max=100)),
      ),

      h4(HTML("<strong>Dos 40 aos 49 anos</strong>")),
      fluidRow(align='center',
        column(4, numericInput("T0_5", "Pessoas"    , min=0, value=Def_T0[5],
                               step=100)),
        ...
        column(3, numericInput("NVax_5", "Antivaxx/Não Vacinável",
                               min=0, value=100*Def_NVax[5], max=100)),
        column(3, numericInput("LE_5", "Esperança Média de Vida",
                               min=0, value=Def_LifeExp[5], max=100)),
      ),

      h4(HTML("<strong>Dos 50 aos 59 anos</strong>")),
      fluidRow(align='center',
        column(4, numericInput("T0_6", "Pessoas"    , min=0, value=Def_T0[6],
                               step=100)),
        ...
        column(3, numericInput("NVax_6", "Antivaxx/Não Vacinável",
                               min=0, value=100*Def_NVax[6], max=100)),
        column(3, numericInput("LE_6", "Esperança Média de Vida",
                               min=0, value=Def_LifeExp[6], max=100)),
      ),

      h4(HTML("<strong>Dos 60 aos 69 anos</strong>")),
      fluidRow(align='center',
        column(4, numericInput("T0_7", "Pessoas"    , min=0, value=Def_T0[7],
                               step=100)),
        ...
        column(3, numericInput("NVax_7", "Antivaxx/Não Vacinável",
                               min=0, value=100*Def_NVax[7], max=100)),
        column(3, numericInput("LE_7", "Esperança Média de Vida",
                               min=0, value=Def_LifeExp[7], max=100)),
      ),

      h4(HTML("<strong>Dos 70 aos 79 anos</strong>")),
      fluidRow(align='center',
        column(4, numericInput("T0_8", "Pessoas"    , min=0, value=Def_T0[8],
                               step=100)),
        ...
        column(3, numericInput("NVax_8", "Antivaxx/Não Vacinável",
                               min=0, value=100*Def_NVax[8], max=100)),
        column(3, numericInput("LE_8", "Esperança Média de Vida",
                               min=0, value=Def_LifeExp[8], max=100)),
      ),

      h4(HTML("<strong>Mais de 80 anos</strong>")),
      fluidRow(align='center',
        column(4, numericInput("T0_9", "Pessoas"    , min=0, value=Def_T0[9],
                               step=100)),
        ...
        column(3, numericInput("NVax_9", "Antivaxx/Não Vacinável",
                               min=0, value=100*Def_NVax[9], max=100)),
        column(3, numericInput("LE_9", "Esperança Média de Vida",
