  ...
  sidebarLayout(
    sidebarPanel(
      ...
      fluidRow(align='center',
        ...
        column(3, numericInput("u_1", "Susceptibilidade", min=0, value=Def_u[1],
                               max=1)),
      ...
      fluidRow(align='center',
        ...
        column(3, numericInput("u_2", "Susceptibilidade" , min=0, value=Def_u[2],
                               max=1)),
      ...
      fluidRow(align='center',
        ...
        column(3, numericInput("u_3", "Susceptibilidade" , min=0, value=Def_u[3],
                               max=1)),
      ...
      fluidRow(align='center',
        ...
        column(3, numericInput("u_4", "Susceptibilidade" , min=0, value=Def_u[4],
                               max=1)),
      ...
      fluidRow(align='center',
        ...
        column(3, numericInput("u_5", "Susceptibilidade" , min=0, value=Def_u[5],
                               max=1)),
      ...
      fluidRow(align='center',
        ...
        column(3, numericInput("u_6", "Susceptibilidade" , min=0, value=Def_u[6],
                               max=1)),
      ...
      fluidRow(align='center',
        ...
        column(3, numericInput("u_7", "Susceptibilidade", min=0, value=Def_u[7],
                               max=1)),
      ...
      fluidRow(align='center',
        ...
        column(3, numericInput("u_8", "Susceptibilidade", min=0, value=Def_u[8],
                               max=1)),
      ...
      fluidRow(align='center',
        ...
        column(3, numericInput("u_9", "Susceptibilidade", min=0, value=Def_u[9],
                               max=1)),
